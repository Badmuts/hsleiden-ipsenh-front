...
.then(deployment => {
    ...
    var composeProjectName = (env == 'production' || env == 'staging') ? `front${env}` : `front${travisBranch}`;
    ...
    function(code, stdout, stderr) {
        var logUrl = `https://travis-ci.com/Badmuts/hsleiden-ipsenh-front/builds/${process.env.TRAVIS_BUILD_ID}`;
        var envUrl = (env == 'staging') ? `https://staging.front.ipsenh.daan.codes` : (env == 'production') ? `https://front.ipsenh.daan.codes` : `https://${travisBranch}.front.ipsenh.daan.codes`;
